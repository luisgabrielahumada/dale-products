namespace Swagger.Configuration
{
    public class SwaggerConfiguration
    {
        ...
        /// </summary>
        public const string EndpointDescription = "API v1";
        ...
        /// <para>Foo API</para>
        /// </summary>
        public const string DocInfoTitle = "API";
        ...
        /// </summary>
        public const string DocInfoDescription = "Api - Web API in ASP.NET Core";
